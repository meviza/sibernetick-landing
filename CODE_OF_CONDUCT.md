...
(Security Advisories for anything sensitive, otherwise a private maintainer
contact listed on the project homepage). All complaints will be reviewed
...
1. **Correction** — Private written warning for inappropriate language.
...
4. **Permanent Ban** — Permanent ban from public interaction with the community.
